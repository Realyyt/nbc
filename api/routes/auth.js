  ...
  try {
    ...
    if (affiliateCode) {
      ...
      if (affiliateResult.rows.length > 0) {
        ...
        await runQuery(
          'INSERT INTO affiliate_referrals (affiliate_id, referred_user_id, status) VALUES ($1, $2, $3)',
          [affiliateId, user.id, 'pending']
        );
      }
    }
