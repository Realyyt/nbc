  ...
  globalGold: [
    {
      ...
      description: "Join the NBTA Global Gold Platform — where hands-on experience meets expert mentorship. Through physical dual apprenticeship, face-to-face guidance, and real-world simulation, we don't just teach skills — we shape futures."
    },
    {
      title: "Learn by Doing. Grow by Mentorship. Succeed by Design.",
      description: "At NBTA Global Gold Platform, we bring your career dreams to life through immersive, on-the-job training, expert handholding, and life-changing apprenticeship. This is more than learning — it's transformation."
    }
  ],
  online: [
    {
      title: "Anywhere. Anytime. Your Future Starts Online.",
      description: "With NBTA's Virtual Platform, access world-class mentors, interactive learning, and flexible training — all from the comfort of your device. It's not just online learning — it's a digital gateway to your dreams."
    },
    {
